    ...
    <div class="modal fade" id="registra-producto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form id="formulario" class="form-group" action="../admin/libros/agrega_libro.php" method="POST" enctype="multipart/form-data">
           ...
           <td colspan="2"><input type="text" class="form-control" required readonly id="id-prod" name="id-prod" readonly="readonly" style="visibility:hidden; height:5px;"/></td>
                    ...
                    <tr>
                        <td>Foto: </td>
                        <td><input type="text" class="form-control" required name="foto" id="foto" maxlength="100" accept="image/*" value="valor_predeterminado.jpg"/></td>
                    </tr>
                    <tr>
                        <td>Nombre: </td>
