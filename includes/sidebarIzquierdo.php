	    ...
	    <div class="brands_products"><!--brands_products-->
			...
			<div class="brands-name">
				<ul class="nav nav-pills nav-stacked">
				 <li><a href="#"> <span class="pull-right">(50)</span>Tecnología</a></li>
				<li><a href="#"> <span class="pull-right">(56)</span>Web</a></li>
				<li><a href="#"> <span class="pull-right">(27)</span>Informática</a></li>
				<li><a href="#"> <span class="pull-right">(32)</span>Programación</a></li>
				<li><a href="#"> <span class="pull-right">(5)</span>Estadísticas</a></li>
				<li><a href="#"> <span class="pull-right">(9)</span>Finanzas</a></li>
				<li><a href="#"> <span class="pull-right">(4)</span>Administración</a></li>
				 <li><a href="#"> <span class="pull-right">(50)</span>Tecnología</a></li>
				<li><a href="#"> <span class="pull-right">(56)</span>Web</a></li>
				<li><a href="#"> <span class="pull-right">(27)</span>Informática</a></li>
				<li><a href="#"> <span class="pull-right">(32)</span>Programación</a></li>
