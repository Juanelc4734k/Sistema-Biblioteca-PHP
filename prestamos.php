			...
			<div class="container">
			     <div class="row">
			         ...
			         <div class="col-md-5">
			            ...
			            <p>
			            	La Biblioteca de la Institucición Educativa Barrio Santa Margarita cuenta con algunos libros disponibles para los estudiantes los cuales pueden 
			            	solicitar prestados. El encargado de la biblioteca atenderá al o los estudiantes que lleguen al lugar
			            	
			            </p>
						<div>
							<a href="busqueda.php"><button class="btn btn-success"> prestar libro</button></a>
						</div>
			         </div>
