                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                               ...
                               <img src="images/home/logo.png" width="100px" height="100px">
        ...
        <div class="modal-body">
          <div>
            ...
            <div class="row">
             ...
             <div class="col-md-9">
               <input type="tel" class="form-control" name="telefono" required="required" placeholder="Telefono" value=""> 
             </div>  
            </div>
             <div class="row">
             ...
             <div class="row">
               <div class="col-md-3"><label>Fecha Nacimiento:</label></div>
             <div class="col-md-9">
               <input type="date" class="form-control" name="edad" required="required" placeholder="Fecha" value=""> 
             </div>  
            </div>
             <div class="row">
