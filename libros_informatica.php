...
$consulta=mysqli_query($con, "select * from libros where id_categoria = 20 limit 0,6");
	...
	<br>
			<div class="container">
			     <div class="row">
			         ...
			         <div class="col-md-5">
			            <h3>Libros de Ficcion</h3>
			            <p>
						Estos libros te ayudarán a aprender y entender el mundo de la informática en todos sus aspectos, con estos libros los estudiantes podrán usar esta herramienta que hoy es tan importante en cualquier ámbito. En algunos de los Libros puedes aprender a desarrollar programas, sistemas completos.
			         </div>
